...
class AddAssetForm extends StatefulWidget {
  ...
  const AddAssetForm({required this.onAdd, super.key});
...
class _AddAssetFormState extends State<AddAssetForm> {
  ...
  Widget _buildTypeDropdown() {
    return DropdownButtonFormField<String>(
      ...
      onChanged: (value) => setState(() {
        _type = value!;
        if (_type == 'Cash') _dateOfPurchase = null;
      }),
  ...
  Widget _buildValueField() {
    return TextFormField(
      ...
      onChanged: (value) => _value = double.tryParse(value) ?? 0.0,
      validator: (value) => value == null || value.isEmpty ? 'Required' : null,
    );
  }
  ...
  Widget _buildButtonRow() {
    return Row(
      children: [
        ...
        Expanded(
          child: _buildActionButton('Add Asset', _handleSubmit),
        ),
      ],
    );
  }
