// dialogs/set_goal_dialog.dart
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:google_fonts/google_fonts.dart';

class SetGoalDialog extends StatefulWidget {
  final Function(String, double) onGoalSet;

  const SetGoalDialog({super.key, required this.onGoalSet});
...
class _SetGoalDialogState extends State<SetGoalDialog> {
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildActionButton('Set Goal', _handleSubmit),
            ],
          ),
        ),
      ),
  ...
  void _handleSubmit() {
    if (_formKey.currentState!.validate()) {
      ...
      widget.onGoalSet(selectedCategory, amount);
